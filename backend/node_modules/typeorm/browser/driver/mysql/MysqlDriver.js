...
export class MysqlDriver {
    ...
    loadDependencies() {
        ...
        try {
            ...
            const mysql = this.options.driver || PlatformTools.load(connectorPackage);
            this.mysql = mysql;
            /*
            ...
            if (Object.keys(this.mysql).length === 0) {
                throw new TypeORMError(`'${connectorPackage}' was found but it is empty. Falling back to '${fallbackConnectorPackage}'.`);
            }
        }
        catch (e) {
            try {
                ...
                throw new DriverPackageNotInstalledError("Mysql", connectorPackage);
            }
        }
    }
    /**
